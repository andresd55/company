...
import { DropdownModule } from '../../primeng/dropdown/public_api';
...
@Component({
    ...
    styleUrls: ['../scanner/scanner.component.css'],
    host: {
        'class': 'p-element'
    }
})
export class Scanner implements AfterContentInit, OnInit, OnDestroy {
    ...
    loadCamera() {
        this.camera = [
            { codigo: 1, nombre: "camara 1" },
            { codigo: 2, nombre: "camara 2" }
        ];
    }
...
@NgModule({
    imports: [CommonModule, FocusTrapModule, RippleModule,DropdownModule ],
