                ...
                <a role="tab" class="p-accordion-header-link " (click)="toggle($event)" (keydown)="onKeydown($event)" [attr.tabindex]="disabled ? null : 0"
                    ...
                    <div class="row w-100" *ngIf="!customHeader" >
                        ...
                        <div class="col-3 text-right pr-1 d-table">
                            ...
                            value="1"
                            label=""
                            (onChange)="checkChange.emit($event)"
                            ></p-checkbox>
                        </div>
...
@NgModule({
    imports: [CommonModule, CheckboxModule, TranslateModule.forRoot({
        loader: {
